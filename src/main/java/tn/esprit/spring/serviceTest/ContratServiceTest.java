...
public class ContratServiceTest {
	...
	public void testDeleteContrat(){
		 String msg=cs.deleteContrat(10);
	...
	public void testRetrieveAllUsers() {
		...
		assertEquals(4, listContrats.size());
	}
	
	@Test
	public void testRetrieveUser() {
		Contrat contratRetrieved = cs.retrieveContratById(9); 
		assertEquals(9, contratRetrieved.getReference());
	}
